...
#for the title: 
title = Label(app, text="MEDUIM TEXT", anchor=CENTER, font=("Arial Rounded MT Bold",20), bg="pink", fg='black', relief="solid")
title.place(x=274, y=20)
...
def random_sent():
    ...
    s=open("random_meduim.txt", "r").read()
